...
const messages: Record<Locale, Messages> = {
  en: {
    ...
    'analytics.smartV3Legend': 'Smart system (V3, realistic HVAC)',
    'analytics.tableView': 'Table view (all hours)',
    'analytics.hour': 'Hour',
    'analytics.currentKw': 'Current (kW)',
    'analytics.smartKw': 'Smart (kW)',
    'analytics.smartV3Kw': 'Smart V3 (kW)',
    'analytics.currentCumKwh': 'Current cum. (kWh)',
    'analytics.smartCumKwh': 'Smart cum. (kWh)',
    'analytics.smartV3CumKwh': 'Smart V3 cum. (kWh)',
    'analytics.v3Energy': 'Smart Energy (V3)',
    'analytics.v3PctReduction': '% Reduction (V3)',
    'analytics.v3EnergySaved': 'Energy Saved (V3)',
  ...
  ko: {
    ...
    'analytics.smartV3Legend': '스마트 시스템 (V3, 실제 HVAC 물리)',
    'analytics.tableView': '표로 보기 (전체 시간)',
    'analytics.hour': '시간',
    'analytics.currentKw': '현재 (kW)',
    'analytics.smartKw': '스마트 (kW)',
    'analytics.smartV3Kw': '스마트 V3 (kW)',
    'analytics.currentCumKwh': '현재 누적 (kWh)',
    'analytics.smartCumKwh': '스마트 누적 (kWh)',
    'analytics.smartV3CumKwh': '스마트 V3 누적 (kWh)',
    'analytics.v3Energy': '스마트 에너지 (V3)',
    'analytics.v3PctReduction': '절감률 (V3)',
    'analytics.v3EnergySaved': '절감 에너지 (V3)',
