...
const messages: Record<Locale, Messages> = {
  en: {
    ...
    'simulation.smartEnergy': 'Smart Energy',
    ...
    'simulation.smartLegend': 'Smart system',
    'simulation.smartV3Legend': 'Smart system (V3, realistic HVAC)',
    'simulation.tableView': 'Table view (all hours)',
    'simulation.hour': 'Hour',
    'simulation.currentKw': 'Current (kW)',
    'simulation.smartKw': 'Smart (kW)',
    'simulation.smartV3Kw': 'Smart V3 (kW)',
    'simulation.currentCumKwh': 'Current cum. (kWh)',
    'simulation.smartCumKwh': 'Smart cum. (kWh)',
    'simulation.smartV3CumKwh': 'Smart V3 cum. (kWh)',
    'simulation.v3Energy': 'Smart Energy (V3)',
  ...
  ko: {
    ...
    'simulation.smartEnergy': '스마트 에너지',
    ...
    'simulation.smartLegend': '스마트 시스템',
    'simulation.smartV3Legend': '스마트 시스템 (V3, 실제 HVAC 물리)',
    'simulation.tableView': '표로 보기 (전체 시간)',
    'simulation.hour': '시간',
    'simulation.currentKw': '현재 (kW)',
    'simulation.smartKw': '스마트 (kW)',
    'simulation.smartV3Kw': '스마트 V3 (kW)',
    'simulation.currentCumKwh': '현재 누적 (kWh)',
    'simulation.smartCumKwh': '스마트 누적 (kWh)',
    'simulation.smartV3CumKwh': '스마트 V3 누적 (kWh)',
    'simulation.v3Energy': '스마트 에너지 (V3)',
