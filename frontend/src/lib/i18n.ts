...
const messages: Record<Locale, Messages> = {
  en: {
    ...
    'analytics.tab.electric': 'Electric Energy',
    ...
    'analytics.electricTitle': 'Electric Energy',
    'analytics.electricSubtitle': 'AC power draw over time.',
  ...
  ko: {
    ...
    'analytics.electricSubtitle': '시간대별 에어컨 전력 사용량.',
